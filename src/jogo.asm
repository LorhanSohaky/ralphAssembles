...
DESENHA_FELIX:
    ...
    add ebx, SIZEOF inicioFelix										; Vai para a prขxima linha do desesenho do Felix
...
DESENHA_LINHA:
	...
	add ebx, SIZEOF desenhoRalph									; Vai para a prขxima linha do desesenho do Ralph
	inc ah															; Incrementa a posio Y
	loop DESENHA_LINHA	
...
PROXIMA_VIDA:
	...
	add eax, TYPE VidaStruct										; Vai para a prขxima vida
	add bl, 6														; Soma a posio Y para printar a prขxima vida
	loop PROXIMA_VIDA
...
desenhaLVida PROC
	...
	inc ah															; Incrementa a posio Y
	add ebx, SIZEOF desenhoVida										; Vai para a prขxima linha do desenhoVida
...
; Saกda: edi: OFFSET destino, esi: OFFSET origem
...
; quebrada no cen rio
; Entrada: source: กndice da janela, conteudo: conteudo
; que ser  desenhado
; Saกda: Nada
...
atualizarBit PROC
    ...
    cmp bit.posicaoY, ROWS											; Verifica se a posio do bit  menor que o nฃmero de linhas
